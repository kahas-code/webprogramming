      ...
      <div class="content-area-inner">
        ...
        <section id="intro">
          ...
          <div class="container-mid">
            ...
            <div class="animation-container animation-fade-down" data-animation-delay="0">
              <h1>I’m Khairul Abidin,</h1>
            </div>
            <!-- /ANIMATION CONTAINER -->

            <!-- ANIMATION CONTAINER -->
            <div class="animation-container animation-fade-left" data-animation-delay="300">
              <p class="subline">Menjadi mahasiswa D3-Teknik Informatika Politeknik Kampar sejak Oktober 2020</p>
            </div>
            <!-- /ANIMATION CONTAINER -->
        ...
        <section id="about">
          ...
          <p class="scroll-animated-from-right">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam semper faucibus eros, quis imperdiet sapien. Nam sodales nec risus nec interdum. Proin lobortis, ex condimentum ultricies eleifend, nisl nunc sollicitudin odio, eget
            egestas est turpis et metus. In non ligula quis mauris rutrum porta.
          </p>

          <p class="scroll-animated-from-right">
            Duis consectetur massa sit amet nibh rhoncus, at pharetra ligula aliquet. Ut ac velit vestibulum, eleifend diam ut, malesuada nisi. Sed vel felis vitae diam luctus commodo. Nunc ipsum est, vulputate id orci ac, luctus
            consectetur sapien.
          </p>
        </section>
        <!-- /ABOUT -->
          ...
          <div class="showcase">
            ...
            <div class="item scroll-animated-from-right">
              ...
              <a href="#" data-featherlight="#item-1-lightbox">
                ...
                <div class="background-image" style="background-image: url(<?php echo $url?>img/work/item-1.jpg)"></div>
              </a>
              <!-- /LIGHTBOX LINK -->

              <!-- LIGHTBOX -->
              <div id="item-1-lightbox" class="work-lightbox">
                <img class="img-responsive" src="<?php echo $url?>img/work/item-1.jpg" alt="image" />

                <h3>Fashion Inc.</h3>
                <p class="subline">Web Design</p>

                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam semper faucibus eros, quis imperdiet sapien. Nam sodales nec risus nec interdum. Proin lobortis, ex condimentum ultricies eleifend, nisl nunc sollicitudin
                  odio, eget egestas est turpis et metus. In non ligula quis mauris rutrum porta.
                </p>
              </div>
              <!-- /LIGHTBOX -->
            </div>
            ...
            <div class="item scroll-animated-from-right">
              ...
              <a href="#" data-featherlight="#item-2-lightbox">
                ...
                <div class="background-image" style="background-image: url(<?php echo $url?>img/work/item-2.jpg)"></div>
              </a>
              <!-- /LIGHTBOX LINK -->

              <!-- LIGHTBOX -->
              <div id="item-2-lightbox" class="work-lightbox">
                <img class="img-responsive" src="<?php echo $url?>img/work/item-2.jpg" alt="image" />
            ...
            <div class="item scroll-animated-from-right">
              ...
              <a href="#" data-featherlight="#item-3-lightbox">
                ...
                <div class="background-image" style="background-image: url(<?php echo $url?>img/work/item-3.jpg)"></div>
              </a>
              <!-- /LIGHTBOX LINK -->

              <!-- LIGHTBOX -->
              <div id="item-3-lightbox" class="work-lightbox">
                <img class="img-responsive" src="<?php echo $url?>img/work/item-3.jpg" alt="image" />
            ...
            <div class="item scroll-animated-from-right">
              ...
              <a href="#" data-featherlight="#item-4-lightbox">
                ...
                <div class="background-image" style="background-image: url(<?php echo $url?>work/item-4.jpg)"></div>
              </a>
              <!-- /LIGHTBOX LINK -->

              <!-- LIGHTBOX -->
              <div id="item-4-lightbox" class="work-lightbox">
                <img class="img-responsive" src="<?php echo $url?>work/item-4.jpg" alt="image" />
